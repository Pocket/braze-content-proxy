...
export const graphCollectionFixture ={
  data: {
    getCollectionBySlug: {
      ...
      excerpt: "Breaking down the complexities of society with help from Michael Scott, Homer Simpson, and Neopets. ",
      imageUrl: "https://s3.amazonaws.com/pocket-collectionapi-prod-images/aef6a1a8-3f6c-4281-b7fc-440e4a3ff8bc.jpeg",
      ...
      stories: [
        {
          ...
          "excerpt": "**Lucy Blakiston**: “Even though I’m not a fan of Minions (this may be an unpopular opinion)",
          "imageUrl": "https://s3.amazonaws.com/pocket-collectionapi-prod-images/92631502-7403-4900-9bd6-6eb86398fdb9.jpeg",
          "publisher": "Vox",
          "authors": [
            {
              "name": "test author-1"
        ...
        },
        {
          ...
          "imageUrl": "https://s3.amazonaws.com/pocket-collectionapi-prod-images/609a0ffd-d9af-4cda-b911-9e40397611bc.jpeg",
          "publisher": "Jezebel",
          "authors": [
            {
              "name": "Chelsea Beck"
...
export const brazeCollectionsFixture : BrazeCollections = Object.freeze({
  ...
  imageUrl: getResizedImageUrl(graphCollectionFixture.data.getCollectionBySlug.imageUrl),
  stories: graphCollectionFixture.data.getCollectionBySlug.stories.map(story => {
    return {
      ...story,
